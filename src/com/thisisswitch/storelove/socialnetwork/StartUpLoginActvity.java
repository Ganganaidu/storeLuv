...
public class StartUpLoginActvity extends SherlockFragmentActivity implements OnClickListener,
ConnectionCallbacks, OnConnectionFailedListener,PlusClient.OnPeopleLoadedListener{
	...
	private void intiliszeUi() {
		...
		skip_textView2.setVisibility(View.VISIBLE);
		...
		//			Intent in = new Intent(StartUpLoginActvity.this,RegionsListActivity.class);
		//			startActivity(in);
		//		}
	}
	@Override
	...
	public void onClick(View v) {
		...
		case R.id.skip_textView2:
			...
			Intent in = new Intent(StartUpLoginActvity.this,StoreLoveActivity.class);
			startActivity(in);
			finish();
		...
		case R.id.login_button:
			...
			if(mUserRegModel.user_name.length() == 0) {
				...
				Toast.makeText(StartUpLoginActvity.this, "Please enter username", Toast.LENGTH_SHORT).show();

			} else if(mUserRegModel.user_password.length() == 0) {

				Toast.makeText(StartUpLoginActvity.this, "Please enter password", Toast.LENGTH_SHORT).show();
		...
		case R.id.facebook_button:
			if(Networking.isNetworkAvailable(this)) {
				...
				if(!mAppPreferences.getUserid().equals("0")) {
					Toast.makeText(StartUpLoginActvity.this, "Please log out", Toast.LENGTH_SHORT).show();
				} else {
				...
				Toast.makeText(StartUpLoginActvity.this, Networking.mNewtWorkState, Toast.LENGTH_SHORT).show();
			}
			break;
	...
	private void validRegValues() {
		...
		if(mUserRegModel.user_name.length() == 0 ) {
			...
			Toast.makeText(StartUpLoginActvity.this, "Password not matching ", Toast.LENGTH_SHORT).show();

		} else if(mUserRegModel.user_mail.length() == 0 || !isEmailValid(mUserRegModel.user_mail)) {

			Toast.makeText(StartUpLoginActvity.this, "Please enter valid mail id", Toast.LENGTH_SHORT).show();

		}  else if(mUserRegModel.user_phonenumber.length() == 0 || mUserRegModel.user_phonenumber.length() < 10 ) {

			Toast.makeText(StartUpLoginActvity.this, "Please enter valid phone number", Toast.LENGTH_SHORT).show();
	...
	private void getSnapImage() {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(StartUpLoginActvity.this);
	...
	private void fbLogin() {
		...
		Session.openActiveSession(this, true, new Session.StatusCallback() {
			...
			public void call(Session session, SessionState state, Exception exception) {
				//Toast.makeText(StartUpLoginActvity.this, "session opend-->"+session.isOpened(), Toast.LENGTH_SHORT).show();
				if (session.isOpened()) {
	...
	public void onConnected(Bundle connectionHint) {
		...
		mPlusClient.loadPeople(StartUpLoginActvity.this, "me");
	}
	...
	private class UserRegistrationAsyncTask extends AsyncTask<String, Void, String>{
		...
		protected void onPreExecute() {
			//Log.d(TAG,"userRegUrl-->"+userRegUrl);
			mProgressDialog = new ProgressDialog(StartUpLoginActvity.this);
		...
		protected void onPostExecute(String response) {
			...
			if(response.equalsIgnoreCase("0") || response.equalsIgnoreCase("")) {
				Toast.makeText(StartUpLoginActvity.this, resultres, Toast.LENGTH_SHORT).show();
			} else {
