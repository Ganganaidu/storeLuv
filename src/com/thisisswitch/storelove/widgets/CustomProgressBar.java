...
public class CustomProgressBar extends View {
	...
	//private int mProgressMode = SWEEP_MODE;
	...
	/* Default color data */
	private int mCircleColor = Color.parseColor("#FE2E64");

	private int mBarColor = Color.parseColor("#898989");
	...
	private void extraAttributes(TypedArray array) {
		...
		this.mBarLengthRatio = (int) array.getDimension(
				R.styleable.apps_barLengthRatio, spinbarCoverage);
...
//				mPadding);
	...
	public void execute() {
		...
		case SPIN_MODE:
			try {
				//Removes any previous handler calls
