...
public class RegionsListActivity extends SherlockFragmentActivity implements OnClickListener, MapLibraryInterface {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		region_listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,long arg3) {
				...
				Toast.makeText(RegionsListActivity.this, regionLIst.get(position).getRegion_name(), Toast.LENGTH_SHORT).show();
				finish();
			}
		});
	}
	...
	private class LoadRegionsTask extends AsyncTask<String, String, Boolean> {
		...
		protected void onPreExecute() {
			mActivityIndicator  =  new ProgressDialog(RegionsListActivity.this);
		...
		protected void onPostExecute(Boolean result) {
			...
			if(result) {
				...
				try{ 
					adapter = new RegionListAdapter(RegionsListActivity.this, regionLIst);
				...
				Toast.makeText(RegionsListActivity.this, "No Location listed", Toast.LENGTH_SHORT).show();
			}
		}
	}
	...
	protected class GetAddressTask extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			 ...
			 * can also be used.
			 */
			Geocoder geocoder = new Geocoder(RegionsListActivity.this, Locale.getDefault());
		...
		public void onPostExecute(String reponse) {
			...
			seleted_region_textView.setText(mAppPreferences.getRegionName());
			Toast.makeText(RegionsListActivity.this, regionName, Toast.LENGTH_SHORT).show();
		}
	}
